...
import lecture.lecNotice;
import lecture.lecNoticeDAOimp;

/**
 *
 * @author ASUS
 */
public class TOseeNotice extends javax.swing.JFrame {

    /**
     * Creates new form TOseeNotice
     */
    public TOseeNotice() {
        initComponents();
        Load();
...
String Search;
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        ToNoticeDAOimp sImp = new  ToNoticeDAOimp();
        ToNotice l1=sImp.get(Search);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TOseeNotice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TOseeNotice().setVisible(true);
            }
        });
    }
