...
public class medical extends javax.swing.JFrame {
    ...
    public medical() {
     ...
     private void Load(){
            DefaultTableModel df=(DefaultTableModel)SMedical.getModel();
            //String NoticeID="tg001"; 
           
        try {
             Connection conn1=DBconnect.getConnection();
            insert=(PreparedStatement) conn1.prepareStatement("select * from medical where st_id='tg001'");
            ...
            while(rs.next()){
                ...
                v1.add(rs.getDate("day"));
                v1.add(rs.getString("type"));
                v1.add(rs.getInt("hours"));
                df.addRow(v1);          
            }
    ...
    private void initComponents() {
        ...
        SMedical = new javax.swing.JTable();
        ...
        jLabel1.setText("Student medical Details..");

        SMedical.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        SMedical.setPreferredSize(new java.awt.Dimension(300, 50));
        jScrollPane1.setViewportView(SMedical);
        if (SMedical.getColumnModel().getColumnCount() > 0) {
            SMedical.getColumnModel().getColumn(2).setResizable(false);
        }
    ...
    private javax.swing.JTable SMedical;
