 ...
 * @author ASUS
 */
public class studentEligiblity extends javax.swing.JFrame {

    /**
     * Creates new form studentEligiblity
     */
    public studentEligiblity() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentEligiblity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentEligiblity().setVisible(true);
            }
        });
    }
